...
var wobbleSpeedE = 1, wobbleDistE = 4;

enemy.prototype.act = function(step) {
  this.wobble += step * wobbleSpeedE;
  var wobblePosE = Math.sin(this.wobble) * wobbleDistE;
  this.pos = this.basePos.plus(new Vector(wobblePosE, 0));
};
